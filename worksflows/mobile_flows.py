...
class MobileFlows:
    ...
    def mortgage_flow(amount, term, rate, save):
        MobileActions.send_keys(page.mobile_calculator.get_amount(), amount)
        MobileActions.send_keys(page.mobile_calculator.get_term(), term)
        MobileActions.send_keys(page.mobile_calculator.get_rate(), rate)
